...
namespace Realtor.Http
{
    ...
    public class CustomWebRequest : IDisposable
    {
        ...
        public string ResponseString
        {
            ...
            {
                string resultData = "";
                using (StreamReader streamRead = new StreamReader(_ResponseStream, Encoding.UTF8))
                {
                    resultData = streamRead.ReadToEnd();
                }
                /*
        ...
        public void PostData()
        {
            ...
            foreach (Cookie c in _myHttpWebResponse.Cookies)
            {
                if (_cookies == null)
